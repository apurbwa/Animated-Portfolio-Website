...
const Contact = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs
       .sendForm('service_i6wvdqg', 'template_9rey31i', formRef.current, {
         publicKey: 'TqOIlJNG5PRGpPjwD',
       })
       .then(
         () => {
            setSuccess(true);
  ...
  return (
    <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
      <motion.div className="textContainer" variants={variants}>
         ...
         <motion.div className="item" variants={variants}>
            <h2>Phone</h2>
            <span>+49 1575 7475 368</span>
         </motion.div>
      </motion.div>
      <div className="formContainer">
         <motion.div className="phoneSVG" 
            initial={{ opacity: 1 }} 
            whileInView={{ opacity: 0, transition: { duration: 3, delay: 1 }}} 
         >
         ...
         >
            ...
            {success && <span>Thanks for reaching out! I will get back to you soon.</span>}
         </motion.form>
      </div>
    </motion.div>
  )
